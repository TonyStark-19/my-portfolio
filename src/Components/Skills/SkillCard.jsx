...
export default function SkillCard({ img, label }) {
    return (
        <div
            className="flex items-center gap-2.5 px-3.5 py-2 rounded-xl cursor-default bg-white/3 border border-white/6
            hover:bg-white/[0.07] hover:border-white/[0.14] hover:scale-[1.04] active:scale-[0.98] transition-all duration-200 group"
        >
